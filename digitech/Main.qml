...
PlasmaCore.ColorScope {
   ...
   width: 1920
      ...
      //  }
        ...
        initialItem: Login {
            ...
            actionItems: [
                ...
                ActionButton {
                    iconSource: "/usr/share/icons/Oxyfaenza/48x48/actions/system-reboot.png"
                    ...
                    iconSize: root.generalFontSize * 3.25
                },
                ActionButton {
                    iconSource: "/usr/share/icons/Oxyfaenza/48x48/actions/system-log-out.png"
            ...
            onLoginRequest: {
                root.notificationMessage = "Open Sesame!"
    ...
    Component {
        ...
        Login {
            ...
            userListModel: QtObject {
                ...
                property string iconSource: "/usr/share/sddm/themes/earth-night/components/artwork/gnome-session-switch.png"
            }
    ...
    RowLayout {
       ...
       Label {
        Image {x:160;source:"/run/media/hammer/Data/Pictures/Misc/icons/1200px-RSA_Security_logo2.svg.png";sourceSize.width: 48;sourceSize.height: 48}
        Text{text:"DigiTech Systems";color:"white"}
        }
        
        
       // PlasmaComponents.ToolButton {
          //  text: i18ndc("Digi-Tech Systems", "Digi-Tech Systems", "Digi-Tech Systems")
         //   iconName: inputPanel.keyboardActive ? "input-keyboard-virtual-on" : "input-keyboard-virtual-off"
            //onClicked: inputPanel.showHide()
            // visible: inputPanel.status == Loader.Ready
          //  visible: false
